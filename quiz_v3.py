...
if skip == 1:
    next(csvreader)
    question_01_csv = next(csvreader)
else:
    question_01_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_02_csv = next(csvreader)
else:
    question_02_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_03_csv = next(csvreader)
else:
    question_03_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_04_csv = next(csvreader)
else:
    question_04_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_05_csv = next(csvreader)
else:
    question_05_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_06_csv = next(csvreader)
else:
    question_06_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_07_csv = next(csvreader)
else:
    question_07_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_08_csv = next(csvreader)
else:
    question_08_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_09_csv = next(csvreader)
else:
    question_09_csv = next(csvreader)
    next(csvreader)
skip = random.randrange(0,2)
if skip == 1:
    next(csvreader)
    question_10_csv = next(csvreader)
else:
    question_10_csv = next(csvreader)
    next(csvreader)
...
#--------------------------- questions ------------------------------
question_01 = text(question_01_csv[0],question_01_csv[1],question_01_csv[2],question_01_csv[3],question_01_csv[4])
question_02 = text(question_02_csv[0],question_02_csv[1],question_02_csv[2],question_02_csv[3],question_02_csv[4])
question_03 = text(question_03_csv[0],question_03_csv[1],question_03_csv[2],question_03_csv[3],question_03_csv[4])
question_04 = text(question_04_csv[0],question_04_csv[1],question_04_csv[2],question_04_csv[3],question_04_csv[4])
question_05 = text(question_05_csv[0],question_05_csv[1],question_05_csv[2],question_05_csv[3],question_05_csv[4])
question_06 = text(question_06_csv[0],question_06_csv[1],question_06_csv[2],question_06_csv[3],question_06_csv[4])
question_07 = text(question_07_csv[0],question_07_csv[1],question_07_csv[2],question_07_csv[3],question_07_csv[4])
question_08 = text(question_08_csv[0],question_08_csv[1],question_08_csv[2],question_08_csv[3],question_08_csv[4])
question_09 = text(question_09_csv[0],question_09_csv[1],question_09_csv[2],question_09_csv[3],question_09_csv[4])
question_10 = text(question_10_csv[0],question_10_csv[1],question_10_csv[2],question_10_csv[3],question_10_csv[4])
